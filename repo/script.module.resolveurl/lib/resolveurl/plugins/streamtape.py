...
class StreamTapeResolver(ResolveUrl):
    ...
    domains = ['streamtape.com', 'strtape.cloud', 'streamtape.net', 'streamta.pe', 'streamtape.site',
               ...
               'streamadblockplus.com', 'shavetape.cash', 'streamtape.to', 'streamta.site', 'streamadblocker.xyz', 'tapewithadblock.org']
    pattern = r'(?://|\.)(s(?:tr)?(?:eam|have)?(?:ta?p?e?|cloud|with|adblock(?:plus|er))\.' \
              r'(?:com|cloud|net|pe|site|link|cc|online|fun|cash|to|xyz|org))/(?:e|v)/([0-9a-zA-Z]+)'
