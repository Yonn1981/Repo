...
MOVIE_DUBBED = (f'{URL_MAIN}category/افلام-مدبلجة/', 'showMovies')
...
KID_MOVIES = (f'{URL_MAIN}category/أفلام-انيميشن/', 'showMovies')
...
SERIE_AR = (f'{URL_MAIN}category/مسلسلات-عربية/', 'showSeries')

SPORT_WWE = (f'{URL_MAIN}category/عروض-المصارعة/', 'showMovies')
ANIM_NEWS = (f'{URL_MAIN}category/مسلسلات-انمي/', 'showSeries')

REPLAYTV_NEWS = (f'{URL_MAIN}category/عروض-تليفزيونية/', 'showMovies')
